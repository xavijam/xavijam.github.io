...
themes_dir      = ".themes"     # directory for blog themes
...
task :watch do
  ...
  jekyllPid = Process.spawn({"OCTOPRESS_ENV"=>"preview"}, "jekyll serve --watch --trace")
...
task :combine_js do
  puts "## Combining JS"
  scripts_dir = "#{source_dir}/js"
  system "cat #{scripts_dir}/main.js test.js... > #{scripts_dir}/all.js"
end
